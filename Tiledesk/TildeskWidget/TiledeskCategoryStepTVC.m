...
@interface TiledeskCategoryStepTVC ()

@end

@implementation TiledeskCategoryStepTVC
...
//    }
    ...
    self.navigationItem.title = [TiledeskLocal translate:@"help wizard title topic"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.section == 0) {
        ...
        titleLabel.text = [TiledeskLocal translate:@"Help wizard select argument"];
    }
    if (indexPath.section == 1) {
//        HelpCategory *category = self.categories[indexPath.row];
        TiledeskDepartment *dep = self.departments[indexPath.row];
//        if (category.parent) {
