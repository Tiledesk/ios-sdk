...
@interface TiledeskDescriptionStepTVC ()

@end

@implementation TiledeskDescriptionStepTVC
...
- (void)viewDidLoad {
    ...
    self.nextButton.title = [TiledeskLocal translate:@"Help wizard send button"];
    self.titleLabel.text = [TiledeskLocal translate:@"help wizard title"];
    self.subtitleLabel.text = [TiledeskLocal translate:@"help wizard description"];//@"Descrivi sinteticamente il tuo problema, ti metteremo in contatto con un operatore specializzato";//NSLocalizedString(@"description subtitle", nil);
    self.navigationItem.title = [TiledeskLocal translate:@"help wizard navigation title"];
...
//                                          [self sendStepAskPush];
    ...
    UIAlertAction* cancel = [UIAlertAction
                             actionWithTitle:[TiledeskLocal translate:@"Help wizard not now button"]
